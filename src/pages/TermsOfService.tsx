...
import { Scale, FileCheck, AlertTriangle, CreditCard, Clock, Anchor } from "lucide-react";
  ...
  const sections = [
    {
      ...
      content: [
        `By accessing and using ${siteName}'s services, you agree to be bound by these Terms of Service.`,
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <p className="text-primary-foreground/80 text-lg">
              Please read these terms carefully before using {siteName}'s services. By booking with us, you agree to these terms.
            </p>
          ...
          >
            ...
            >
              ...
              <p className="text-secondary font-medium">
                For questions: legal@{siteName.toLowerCase().replace(/\s+/g, '')}.com
              </p>
            </motion.div>
          </motion.div>
        </div>
